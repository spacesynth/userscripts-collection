...
function force_reject_all() {
    var element1 = document.querySelector('button[aria-label="Cancel autoplay"]');
...
waitForKeyElements('button[aria-label="Cancel autoplay"]', refreshIntervalId4 = setInterval(force_reject_all, 1000));
